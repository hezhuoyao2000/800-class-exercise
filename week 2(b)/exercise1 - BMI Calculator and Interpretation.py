"""
This program calculates the human bmi value and determines the state of health,
also identifies inputs that may be incorrect and gives a solution
...
while True:
    try:
        ...
        if 0 <= height <3:
            ...
            print("Invalid format of height, please try again and make sure the value is between 0 and 3 meters.")
                                                                                #If the user does not enter the number in the unit of meters, re-enter
    except ValueError:
        print("Invalid format,please try again and make sure entering a real number with or without \".\" ")     #If the user enters something that is not a number
